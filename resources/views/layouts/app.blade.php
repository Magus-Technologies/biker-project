        ...
        <div class="flex items-center gap-4">
            @auth
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" @keydown.escape="open = false" class="focus:outline-none">
                        <i class="bi bi-person-circle text-2xl text-blue-700"></i>
                    </button>
                    <div x-show="open" @click.away="open = false" x-cloak
                         class="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-lg py-1 z-50">
                        <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Mi perfil</a>
    ...
    <div x-data="{
        ...
        <nav class="fixed top-0 left-0 w-280 h-screen bg-blue-800 text-white overflow-y-auto z-410" 
            ...
            <div class="mobile-menu-items">
                ...
                @can('ver-conductores')
                    <a href="{{ route('drives.index') }}" class="mobile-menu-item" @click="closeMobileMenu()">

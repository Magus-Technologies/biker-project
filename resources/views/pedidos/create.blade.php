<x-app-layout>
    <x-breadcrumb title="Nuevo Pedido" parent="Pedidos" parentUrl="{{ route('pedidos.index') }}" subtitle="Crear Pedido" />
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-2 bg-white p-6 rounded-lg shadow">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" id="customer_dni" placeholder="Ingrese documento" class="w-full p-2 border rounded">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Teléfono</label>
                        <input type="text" id="customer_phone" placeholder="Teléfono del cliente" class="w-full p-2 border rounded">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-2 mb-4">
                    ...
                    <select id="provinces_id" class="p-2 border rounded" disabled>
                        <option value="todos">Provincia</option>
                    </select>
                    <select id="districts_id" class="p-2 border rounded" disabled>
                ...
                <div class="border-t pt-4 mt-4">
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="datos_mecanico" class="flex-1 p-2 border rounded bg-gray-50" readonly placeholder="Sin mecánico asignado">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="expires_at" class="w-full p-2 border rounded">
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Observaciones</label>
                    <textarea id="observation" rows="3" class="w-full p-2 border rounded" placeholder="Notas adicionales..."></textarea>
                </div>
                ...
                <div class="mt-4 space-y-2">
                    <button type="button" onclick="guardarPedido()" class="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded font-medium">
                        <i class="bi bi-save mr-1"></i> Guardar Pedido
                    </button>
        ...
        .then(result => {
            if (result.success) {
                Swal.fire({
                    icon: 'success',
                    title: 'Pedido creado',
                    text: `Código: ${result.pedido.code}`,

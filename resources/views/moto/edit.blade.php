            ...
            <form id="formMoto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="nro_motor" id="nro_motor" value="{{ $moto->nro_motor }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nro_chasis" id="nro_chasis" value="{{ $moto->nro_chasis }}"
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="marca" id="marca" value="{{ $moto->marca }}" required
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    <div>
                        ...
                        <input type="text" name="modelo" id="modelo" value="{{ $moto->modelo }}" required
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    <div>
                        ...
                        <input type="text" name="anio" id="anio" value="{{ $moto->anio }}" placeholder="2024"
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="color" id="color" value="{{ $moto->color }}"
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    <div>
                        ...
                        <input type="text" name="lugar_provisional" id="lugar_provisional" value="{{ $moto->lugar_provisional }}" placeholder="Ej: Taller, Almacén, etc."
                            class="w-full p-2 border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
...
document.getElementById('formMoto').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('{{ route("motos.update", $moto->id) }}', {
            method: 'POST',
            headers: {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Ocurrió un error al actualizar la moto',
            confirmButtonColor: '#ef4444'
        });
    }
});
